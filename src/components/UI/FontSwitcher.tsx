      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="flex flex-col gap-4 p-4 bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl min-w-[140px] origin-top-left"
          >
            {/* Font Family Section */}
              ...
              <div className="flex flex-col gap-1">
                {fonts.map((font) => (
                  <button
                    ...
                    className={`px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-300 text-left ${
                      currentFont === font.id 
